...
Ten articles covering installation, ad-hoc commands, inventories, your first playbook, variables, conditionals, loops, templating, roles, and debugging.

## Articles in this track

| # | Article | Folder | Status |
|---|---|---|---|
| 1 | [Install Ansible on Rocky Linux 10 & Ubuntu 24.04](https://computingforgeeks.com/install-ansible-rocky-linux-ubuntu/) | `install-ansible-rocky-linux-ubuntu/` | published |
| 2 | [Ansible Ad-Hoc Commands](https://computingforgeeks.com/ansible-ad-hoc-commands/) | `ansible-ad-hoc-commands/` | published |
| 3 | [Ansible Inventory Management](https://computingforgeeks.com/ansible-inventory-management/) | `ansible-inventory-management/` | published |
